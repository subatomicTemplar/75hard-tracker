...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* New Season */}
      <div className="overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900 p-4 space-y-3">
        ...
        <div className="space-y-2">
          <input
            ...
            className="min-w-0 w-full rounded-lg border border-neutral-800 bg-black px-3 py-2.5 text-white placeholder:text-neutral-500 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
          />
          ...
          <input
            ...
            className="min-w-0 w-full rounded-lg border border-neutral-800 bg-black px-3 py-2.5 text-white focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
          />
